...
<footer class="bg-slate-900 text-slate-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-sm text-slate-500">© 2025 SS Water Tank. All rights reserved.</p>
            <div class="flex space-x-4">
                <!-- Social Placeholders -->
                <a href="#" class="text-slate-400 hover:text-white transition"><plugin class="w-5 h-5 bg-slate-700 rounded-full"></plugin></a>
                <a href="#" class="text-slate-400 hover:text-white transition"><div class="w-5 h-5 bg-slate-700 rounded-full"></div></a>
            </div>
        </div>
    </div>
</footer>
